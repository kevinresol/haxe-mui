package mui.material.typography;

import react.ReactType;

typedef HeadlineMapping = {
	@:optional var h1:ReactType;
	@:optional var h2:ReactType;
	@:optional var h3:ReactType;
	@:optional var h4:ReactType;
	@:optional var h5:ReactType;
	@:optional var h6:ReactType;
	@:optional var subtitle1:ReactType;
	@:optional var subtitle2:ReactType;
